				...
				<div class="jr-card-header-color">
					<ul class="contact-list list-unstyled">
						...
						<li class="media">
							...
							<span class="media-body">{data.teacher_personal_info.email}</span>
						</li>
						<li class="media">
							<i class="zmdi zmdi-facebook-box zmdi-hc-fw zmdi-hc-lg text-primary align-self-center"></i>
							<span class="media-body"><a href=".">{data.teacher_personal_info.facebook_url}</a></span>
						</li>
						<li class="media">
							<i class="zmdi zmdi-pin zmdi-hc-fw zmdi-hc-lg text-primary align-self-center"></i>
							<span class="media-body">{data.teacher_personal_info.address}</span>
						</li>
					</ul>
