...
const StaffPersonalInfo =({init_data, setNewData})=>{
			...
			<div className="card px-4 py-3">
				...
				<div className="row m-0">
					<div className="col-sm-6 col-12 p-0">
						<FormControl className="mb-3" style={{minWidth: '80%'}} required>
							...
							<Select
								native
								value={init_data.staff_personal_info.gender}
								onChange={handleChange}
					...
					<div className="col-sm-6 col-12 p-0">
						<TextField
							...
							className="mb-3"
							type="date"
							defaultValue={init_data.staff_personal_info.dob}
							onChange={handleChange}
				...
				<div className="row m-0">
					<div className="col-sm-6 col-12 p-0">
						<TextField 
							id="blood_group" 
							label="Blood Group" 
							value={init_data.staff_personal_info.blood_group}
							onChange={handleChange}
							className="mb-3" 
						/>
					</div>
					<div className="col-sm-6 col-12 p-0">
						<TextField 
							id="religion" 
							label="Religion" 
							value={init_data.staff_personal_info.religion}
							onChange={handleChange}
							className="mb-3" 
						/>
					</div>
				...
				<div className="row m-0">
					<div className="col-sm-6 col-12 p-0">
						<FormControl className="mb-3" fullWidth>
							...
							<Select
								native
								value={init_data.staff_personal_info.marital_status}
								onChange={handleChange}
				...
				<div className="row m-0">
					<div className="col-sm-8 col-12 p-0">
						<TextField
							id="email"
							label="Email"
							value={init_data.staff_personal_info.email}
							onChange={handleChange}
							className='mb-3'
							fullWidth
							InputProps={{
				...
				<div className="row m-0">
					<div className="col-sm-8 col-12 p-0">
						<TextField
							id="facebook_id"
							label="Facebook Link"
							value={init_data.staff_personal_info.facebook_id}
							onChange={handleChange}
							className='mb-3'
							fullWidth
							InputProps={{
				...
				<div>
					<TextField
						id="address"
						label="Address"
						defaultValue={init_data.staff_personal_info.address}
						onChange={handleChange}
						fullWidth
						className="mb-3"
						multiline
