...
class Routine(models.Model):
	...
	created_by = models.ForeignKey(Accounts, on_delete=models.SET_NULL, null=True, related_name='routine_created')
	updated_by = models.ForeignKey(Accounts, on_delete=models.SET_NULL, null=True, related_name='routine_updated')
...
class ClassRoutine(models.Model):
	...
	subject = models.ForeignKey(SubjectList, on_delete=models.SET_NULL, null=True, related_name='get_routine')
	teacher = models.ForeignKey(Teacher, on_delete=models.SET_NULL, null=True, related_name='get_routine')
...
class ClassHappend(models.Model):
	...
	section = models.ForeignKey(Sections, on_delete=models.SET_NULL, related_name='class_happend', null=True)
	subject = models.ForeignKey(SubjectList, on_delete=models.SET_NULL, related_name='class_happend', null=True, blank=True)
	is_proxy = models.BooleanField(default=False)
	taken_by = models.ForeignKey(Teacher, on_delete=models.SET_NULL, related_name='class_taken', null=True, blank=True)
...
class StudentAttendance(models.Model):
	...
	section = models.ForeignKey(Sections, on_delete=models.SET_NULL, null=True, related_name='attendance')
	date = models.DateField(default=timezone.now)
...
class StudentPerClassAttendance(models.Model):
	...
	subject = models.ForeignKey(SubjectList, on_delete=models.SET_NULL, null=True, related_name='class_attendance')
	date = models.DateField(default=timezone.now)
	is_present = models.BooleanField(default=True)
